			...
			<div class="jumbotron">
				...
				<div id="transferFund" class="row">
					<div class="col-sm-10 bg-light" style="padding: 15px; margin-top: 20px;margin-left:8%">
						...
						<form:form  modelAttribute="transaction" action="pay-bills" method="post">
							...
							<div class="form-group">
							<form:label path="remarks" for="remarks">Select Payee</form:label>
							<form:select path="remarks" name="remarks" class="form-control">
							<%
								List<Utility> uList = (List<Utility>)request.getAttribute("utilityList");
								
								for(Utility u : uList){
									
									out.print("<option value="+u.getName()+">"+u.getName()+"</option>");
							...
							<div class="form-group">
								<label for="billnumber">Enter Bill Number:</label>
								 <input path="billnumber" type="text" name="billnumber" class="form-control"
									placeholder="Enter Bill Number/PhoneNumber" id="billnumber" required="true"/>
							</div>
							
							<div class="form-group">
								<form:label path="amount" for="amount">Enter Amount to Send:</form:label> 
								<form:input
